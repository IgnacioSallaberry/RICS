...
with open('C:\\Users\\ETCasa\\Desktop\\DIFFERENCE DIFUSION 6HS DENV CELULA1 RICS NUCLEO CON W0_0_25.txt') as fobj:
...
with open('C:\\Users\\ETCasa\\Desktop\\DIFFERENCE BINDING 6HS DENV CELULA1 RICS NUCLEO CON W0_0_25.txt') as fobj:
...
plt.ylabel('')
plt.legend()
plt.xlim(-0.0025,0.0032)
plt.ylim(0,750)
#plt.title('Histograma normalizado')
plt.tick_params(which='minor', length=8, width=3.5)
plt.tick_params(which='major', length=8, width=3)
figManager = plt.get_current_fig_manager()  ####   esto y la linea de abajo me maximiza la ventana de la figura
figManager.window.showMaximized()      
plt.tight_layout()
